...
// Placeholder — real hashes generated asynchronously below after mockData is declared
  ...
  staff: [
    {
      ...
      password: PLACEHOLDER, status: 'approved', phone: null,
  ...
  admins: [
    {
      ...
      email: 'admin@deped-masbate.gov.ph', password: PLACEHOLDER,
      created_at: new Date().toISOString(),
    },
  ],
  submissions: [],
...
// Generate correct bcrypt hashes now that mockData is declared
(async () => {
  ...
  console.log('  School — email: maria.santos@adventist.edu.ph | password: Staff@1234 | school: Adventist Elementary School-Placer, Inc.');
})();
