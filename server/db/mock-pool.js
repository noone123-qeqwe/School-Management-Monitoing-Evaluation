...
const mockData = {
  schools: [
    { id:  1, name: 'Amazing Progress Learning Center',                  school_code: 'SCH-001', level: 'elementary',   division: 'Division of Masbate' },
    { id:  2, name: 'Andres Soriano Jr. Memorial School',                school_code: 'SCH-002', level: 'elementary',   division: 'Division of Masbate' },
    { id:  3, name: 'Blue Angels Learning Center',                       school_code: 'SCH-003', level: 'kindergarten', division: 'Division of Masbate' },
    { id:  4, name: 'Christina Rose Elementary School',                  school_code: 'SCH-004', level: 'elementary',   division: 'Division of Masbate' },
    { id:  5, name: 'Daughters of St. Joseph Kindergarten School',       school_code: 'SCH-005', level: 'kindergarten', division: 'Division of Masbate' },
    { id:  6, name: "Eden's Christian Academy",                          school_code: 'SCH-006', level: 'elementary',   division: 'Division of Masbate' },
    { id:  7, name: "Eden's Christian Learning Center",                  school_code: 'SCH-007', level: 'elementary',   division: 'Division of Masbate' },
    { id:  8, name: 'G & A Guitierrez Learning Center Inc.',             school_code: 'SCH-008', level: 'elementary',   division: 'Division of Masbate' },
    { id:  9, name: 'Green Meadows Tiny Tots Inc.',                      school_code: 'SCH-009', level: 'kindergarten', division: 'Division of Masbate' },
    { id: 10, name: 'Happy Victory School Inc.',                         school_code: 'SCH-010', level: 'elementary',   division: 'Division of Masbate' },
    { id: 11, name: 'Holy Family Parish Learning Center',                school_code: 'SCH-011', level: 'elementary',   division: 'Division of Masbate' },
    { id: 12, name: 'Holy Name Academy',                                 school_code: 'SCH-012', level: 'junior',       division: 'Division of Masbate' },
    { id: 13, name: 'Immaculate Conception Parish Learning Center',      school_code: 'SCH-013', level: 'elementary',   division: 'Division of Masbate' },
    { id: 14, name: 'Institute of the Orient',                           school_code: 'SCH-014', level: 'senior',       division: 'Division of Masbate' },
    { id: 15, name: 'Liceo de Masbate Colleges Inc.',                    school_code: 'SCH-015', level: 'senior',       division: 'Division of Masbate' },
    { id: 16, name: 'Liceo de San Jacinto Foundation, Inc.',             school_code: 'SCH-016', level: 'junior',       division: 'Division of Masbate' },
    { id: 17, name: 'Mandaon Christian Academy',                         school_code: 'SCH-017', level: 'junior',       division: 'Division of Masbate' },
    { id: 18, name: 'Masbate Central Technical Institute',               school_code: 'SCH-018', level: 'senior',       division: 'Division of Masbate' },
    { id: 19, name: 'Masbate Colleges Inc.',                             school_code: 'SCH-019', level: 'senior',       division: 'Division of Masbate' },
    { id: 20, name: 'Masbate Ikthus Christian School, Inc.',             school_code: 'SCH-020', level: 'junior',       division: 'Division of Masbate' },
    { id: 21, name: 'Masbate Institute of Science and Technology, Inc.', school_code: 'SCH-021', level: 'senior',       division: 'Division of Masbate' },
    { id: 22, name: "Masbate Learning is Fun Children's Center, Inc.",   school_code: 'SCH-022', level: 'kindergarten', division: 'Division of Masbate' },
    { id: 23, name: 'Masbate Polytechnic and Development College',       school_code: 'SCH-023', level: 'senior',       division: 'Division of Masbate' },
    { id: 24, name: 'Masbate Southeastern Institute, Inc.',              school_code: 'SCH-024', level: 'junior',       division: 'Division of Masbate' },
    { id: 25, name: 'Osmeña Colleges',                                   school_code: 'SCH-025', level: 'senior',       division: 'Division of Masbate' },
    { id: 26, name: 'St. Anthony High School Seminary',                  school_code: 'SCH-026', level: 'junior',       division: 'Division of Masbate' },
    { id: 27, name: 'St. Raphael the Archangel Diocesan School',         school_code: 'SCH-027', level: 'junior',       division: 'Division of Masbate' },
    { id: 28, name: 'Yadah Christian School Inc.',                       school_code: 'SCH-028', level: 'elementary',   division: 'Division of Masbate' },
  ],
  staff: [
    {
